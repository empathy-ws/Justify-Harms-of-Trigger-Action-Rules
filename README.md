...
We extract the list of IFTTT services to be mapped into embeddings from the dataset we proposed in [1]. It contains a variety of categories, ranging from online services and content providers to smart home devices, for a total of 435 services. Service descriptions are crawled on the Google Play Store app running the following command
```
python crawler.py
```

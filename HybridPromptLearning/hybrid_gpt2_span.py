...
parser.add_argument('--outf', type=str, default='generated_prompt/generated_gpt2_span_' + threshold + '_' + model_size + '.txt',
...
model_path = os.path.join(args.checkpoint, 'gpt2_span_' + threshold + '_' + model_size + '.pt')

...
train_data = Batchify2(train_df, tokenizer, bos, eos, args.words, args.batch_size, shuffle=True)
val_data = Batchify2(val_df, tokenizer, bos, eos, args.words, args.batch_size)
test_data = Batchify2(test_df, tokenizer, bos, eos, args.words, args.batch_size)
